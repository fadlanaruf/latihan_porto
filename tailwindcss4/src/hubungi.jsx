        ...
        <div className="w-full self-center px-3">
          <section className="hubungi-section">
            ...
            <div className="pendidikan-item">
              <h3 className="buatan">Facebook:</h3>
              <p className="tahun">
                <a href="https://www.facebook.com/aruf.matsubara/">
                  Aruf Matsubara
                </a>
              </p>
            </div>
            <div className="pendidikan-item">
              <h3 className="buatan">Instagram:</h3>
              <p className="tahun">
                {" "}
                <a href="https://www.instagram.com/aruf_fadlan/?hl=id">
                  aruf_fadlan
                </a>
              </p>
            </div>
            <div className="pendidikan-item">
              <h3 className="buatan">Email:</h3>
              <p className="tahun">amarmaruffadlan@gmail.com</p>
              <div className="pendidikan-item">
                <h3 className="buatan">Github:</h3>
                <p className="tahun">
                  <a href="https://github.com/fadlanaruf">fadlanaruf</a>
                </p>
              </div>
            </div>
          </section>
